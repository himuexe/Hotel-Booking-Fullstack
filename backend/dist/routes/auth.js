...
router.post("/login", [(0, express_validator_1.check)("email", "Email is required").isEmail(), //express-validator
    ...
    try {
        ...
        const isMatch = yield bcryptjs_1.default.compare(password, user.password); //true/false
